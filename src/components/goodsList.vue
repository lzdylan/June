...
<script type="text/ecmascript-6">
    export default{
        ...
        methods: {
            ...
            edit: function(index) {
                this.$router.push({path: '/editGoods', query: {cat_name: this.data[index].cat_name}});
            },
            oSwitch: function(index) {
                var _this = this;
                this.axios.post('/api/agoods', this.data[index])
            ...
            remove: function (index) {
                var _this = this;
                this.axios.post('/api/rgoods', {'cat_name': this.data[index].cat_name})
                        .then(function (response) {
